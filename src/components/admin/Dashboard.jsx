...
// import { handleImageError, getEventImageUrl } from "../../utils/imageUtils"
...
//                                 src={event.image_path || getEventImageUrl(event) || "/placeholder.svg"}
//                                 alt={event.name}
//                                 onError={handleImageError}
//                               />
//                             ) : (
//                               <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-medium transition-transform duration-200 group-hover:scale-110 shadow-md">
...
import { UserContext } from "../../context/UserContext"
import { useToast } from "../../context/ToastContext"
import { fetchAllEvents, fetchAllUsers, fetchDashboardStats, deleteEvent } from "../../api/adminApi"
...
const Dashboard = () => {
  ...
  const renderStatCards = () => {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-purple-500 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Users</h3>
          ...
          <div className="mt-4">
            <div className="w-full h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="h-1 bg-purple-500 rounded-full animate-pulse" style={{ width: "60%" }}></div>
            </div>
            <div className="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
              <span>Target: 500</span>
              <span>Current: {stats.totalUsers}</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-500 dark:text-gray-400 text-sm font-medium">Tickets Sold</h3>
          ...
          <div className="mt-4">
            <div className="w-full h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="h-1 bg-green-500 rounded-full animate-pulse" style={{ width: "85%" }}></div>
            </div>
            <div className="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
              <span>Target: 5000</span>
              <span>Current: {stats.totalTickets}</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-yellow-500 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Revenue</h3>
          ...
          <div className="mt-4">
            <div className="w-full h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div className="h-1 bg-yellow-500 rounded-full animate-pulse" style={{ width: "70%" }}></div>
            </div>
            <div className="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
              <span>Target: $75,000</span>
              <span>Current: ${stats.revenue}</span>
            </div>
          </div>
        </div>
      </div>
            ...
            {["Jan", "Feb", "Mar", "Apr", "May", "Jun"].map((month, index) => {
              ...
              return (
                <div key={month} className="flex-1 flex flex-col items-center group">
                  <div
                    className="w-full bg-gradient-to-t from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 rounded-t-sm transition-all duration-300 transform group-hover:scale-105"
                    style={{ height: `${height}%` }}
                  ></div>
                  <div className="text-xs mt-2 text-gray-600 dark:text-gray-400">{month}</div>
                  <div className="text-xs font-medium text-gray-800 dark:text-gray-200">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300">
          ...
          <div className="space-y-4">
            {stats.ticketsByCategory && stats.ticketsByCategory.length > 0
              ? stats.ticketsByCategory.map((item, index) => (
                <div key={index} className="space-y-2 group">
                  ...
                  <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div
                      className={`h-2 rounded-full transition-all duration-500 group-hover:w-full ${index === 0
                          ? "bg-blue-500"
                          : index === 1
                            ? "bg-purple-500"
                            : index === 2
              ...
              : // Placeholder data if no categories
              ["Music", "Sports", "Theater", "Conference", "Other"].map((category, index) => {
                const percentage = [33, 23, 17, 15, 12][index]
                return (
                  <div key={index} className="space-y-2 group">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{category}</span>
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                        {Math.floor(percentage * 30)} tickets ({percentage}%)
                      </span>
                    </div>
                    <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div
  ...
  const renderQuickActions = () => {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8 hover:shadow-lg transition-all duration-300">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Quick Actions</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button
            onClick={() => navigate("/admin/events/create")}
            className="flex flex-col items-center justify-center p-4 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-200 group"
          >
            <FontAwesomeIcon
              icon={faCalendarAlt}
              className="text-2xl mb-2 group-hover:scale-110 transition-transform duration-200"
          ...
          <button
            onClick={() => navigate("/admin/users")}
            className="flex flex-col items-center justify-center p-4 bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors duration-200 group"
          >
            <FontAwesomeIcon
              icon={faUsers}
              className="text-2xl mb-2 group-hover:scale-110 transition-transform duration-200"
          ...
          <button
            onClick={() => navigate("/admin/events")}
            className="flex flex-col items-center justify-center p-4 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors duration-200 group"
          >
            <FontAwesomeIcon
              icon={faListAlt}
              className="text-2xl mb-2 group-hover:scale-110 transition-transform duration-200"
          ...
          <button
            onClick={() => navigate("/admin/settings")}
            className="flex flex-col items-center justify-center p-4 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-600 dark:text-yellow-400 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors duration-200 group"
          >
            <FontAwesomeIcon
              icon={faCog}
              className="text-2xl mb-2 group-hover:scale-110 transition-transform duration-200"
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        ...
        <div className="flex items-center space-x-4 mt-4 md:mt-0">
          <button className="p-2 bg-gray-200 dark:bg-gray-700 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 relative transition-colors duration-200 hover:rotate-12">
            <FontAwesomeIcon icon={faBell} className="w-5 h-5" />
            <span className="absolute top-0 right-0 h-4 w-4 bg-red-500 rounded-full text-xs text-white flex items-center justify-center animate-pulse">
              3
            </span>
          </button>
          <button className="p-2 bg-gray-200 dark:bg-gray-700 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200 hover:rotate-12">
            <FontAwesomeIcon icon={faCog} className="w-5 h-5" />
          </button>
        </div>
      </div>
