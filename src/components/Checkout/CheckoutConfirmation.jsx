...
const CheckoutConfirmation = () => {
  ...
  return (
    <div
      className={`${styles.softGradientBackground} ${window.document.documentElement.classList.contains("dark") ? styles.darkSoftGradientBackground : ""} bg-gradient-to-br pt-24 from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen py-12`}
    >
      {/* Confetti animation */}
      {[...Array(20)].map((_, i) => (
        <div
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className={`mb-8 flex items-center ${styles.fadeInDown}`}
        >
          <button
            onClick={() => navigate(-1)}
            className={`mr-4 p-2 rounded-full bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-shadow ${styles.hoverLift}`}
          >
            <FontAwesomeIcon
              icon={faArrowLeft}
          ...
          <h2
            className={`text-3xl pt-14 font-bold text-gray-900 dark:text-white mb-6 flex items-center ${styles.gradientText}`}
          >
            <div
              className={`w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mr-4 ${styles.successIcon}`}
            >
              <FontAwesomeIcon
                icon={faCheckCircle}
                className={`text-green-600 dark:text-green-400 text-xl ${styles.successAccent}`}
              />
            </div>
            Booking Confirmation
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={handleViewTickets}
                      className={`${styles.primaryComfortableButton} ${styles.comfortableButton} inline-flex items-center justify-center px-6 py-3 border border-transparent shadow-lg text-sm font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200`}
                    >
                      <FontAwesomeIcon icon={faTicketAlt} className="mr-2" />
                      View My Tickets
                    </motion.button>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => navigate("/events")}
                      className={`${styles.secondaryComfortableButton} ${styles.comfortableButton} inline-flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 shadow-md text-sm font-medium rounded-lg text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200`}
                    >
                      Browse More Events
                    </motion.button>
                  </div>
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className={`space-y-5 mb-8 ${styles.staggeredFadeIn}`}>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={handleDownloadTicket}
                  className={`${styles.ticketAction} w-full flex items-center justify-center px-5 py-4 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-800/30 transition-colors duration-200`}
                >
                  <FontAwesomeIcon icon={faDownload} className={`mr-3 text-lg ${styles.ticketActionIcon}`} />
                  Download Ticket PDF
                </motion.button>
                ...
                <motion.button
                  ...
                  className={`${styles.ticketAction} w-full flex items-center justify-center px-5 py-4 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-800/30 transition-colors duration-200`}
                >
                  <FontAwesomeIcon icon={faEnvelope} className={`mr-3 text-lg ${styles.ticketActionIcon}`} />
                  Email Ticket to Me
                </motion.button>
                ...
                <motion.button
                  ...
                  className={`${styles.ticketAction} w-full flex items-center justify-center px-5 py-4 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-800/30 transition-colors duration-200`}
                >
                  <FontAwesomeIcon icon={faPrint} className={`mr-3 text-lg ${styles.ticketActionIcon}`} />
                  Print Tickets
                </motion.button>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => alert("QR code would be displayed here")}
                  className={`${styles.ticketAction} ${styles.qrCodeContainer} w-full flex items-center justify-center px-5 py-4 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-800/30 transition-colors duration-200`}
                >
                  <FontAwesomeIcon icon={faQrcode} className={`mr-3 text-lg ${styles.ticketActionIcon}`} />
                  Show QR Code
                </motion.button>
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">Event Information</h4>
                <div className={`space-y-5 ${styles.staggeredFadeIn}`}>
                  <div
                    className={`flex items-center text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg ${styles.hoverLift}`}
                  >
                    <FontAwesomeIcon
                      icon={faCalendarAlt}
