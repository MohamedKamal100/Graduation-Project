          ...
          {userLogin ? (
            <Link to="/home" className="flex items-center space-x-3">
              ...
              <motion.span
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.2 }}
                className={`self-center text-xl font-bold whitespace-nowrap dark:text-white bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent ${styles.font}`}
              >
                EventVibe
              </motion.span>
            </Link>
