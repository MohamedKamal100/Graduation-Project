...
const Register = () => {
  ...
  // Handle next step
  const handleNextStep = (errors) => {
    if (currentStep === 1) {
      // Check if there are errors in the first step fields
      const step1Fields = ["fname", "lname", "username"]
      const hasErrors = step1Fields.some(field => errors[field] && touchedFields[field])
    ...
    <div className="min-h-screen py-10 relative font-sans overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Animated particles - reduced number and opacity for less distraction */}
          <div className="absolute inset-0 overflow-hidden">
            {[...Array(10)].map((_, i) => (
              <motion.div
                key={i}
                            ...
                            <Field name="fname">
                              {({ field }) => (
                                <input
                                  ...
                                  type="text"
                                  placeholder="Enter your first name"
                                  className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 ${touchedFields.fname && errors.fname
                                    ? "border-red-500/50 focus:border-red-500"
                                    : "border-purple-500/30 focus:border-purple-500/70"
                                    } text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 bg-white/5 backdrop-blur-sm transition-all duration-300`}
                                  {...field}
                                  onBlur={() => handleFieldTouch("fname")}
                                />
                              )}
                            </Field>
                            <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-purple-400 group-focus-within:text-purple-300 transition-colors duration-200">
                            ...
                            <Field name="lname">
                              {({ field }) => (
                                <input
                                  ...
                                  type="text"
                                  placeholder="Enter your last name"
                                  className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 ${touchedFields.lname && errors.lname
                                    ? "border-red-500/50 focus:border-red-500"
                                    : "border-purple-500/30 focus:border-purple-500/70"
                                    } text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 bg-white/5 backdrop-blur-sm transition-all duration-300`}
                                  {...field}
                                  onBlur={() => handleFieldTouch("lname")}
                                />
                              )}
                            </Field>
                            <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-purple-400 group-focus-within:text-purple-300 transition-colors duration-200">
                            ...
                            <Field name="username">
                              {({ field }) => (
                                <input
                                  ...
                                  type="text"
                                  placeholder="Choose a username"
                                  className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 ${touchedFields.username && errors.username
                                    ? "border-red-500/50 focus:border-red-500"
                                    : "border-purple-500/30 focus:border-purple-500/70"
                                    } text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 bg-white/5 backdrop-blur-sm transition-all duration-300`}
                                  {...field}
                            ...
                            <Field name="phone">
                              {({ field }) => (
                                <input
                                  ...
                                  type="tel"
                                  placeholder="Enter your phone number (e.g., 01xxxxxxxxx)"
                                  className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 ${touchedFields.phone && errors.phone
                                    ? "border-red-500/50 focus:border-red-500"
                                    : "border-purple-500/30 focus:border-purple-500/70"
                                    } text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 bg-white/5 backdrop-blur-sm transition-all duration-300`}
                                  {...field}
                          ...
                          <div className="relative group">
                            <Field name="gender">
                              {({ field }) => (
                                <select
                                  id="gender"
                                  className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 ${touchedFields.gender && errors.gender
                                    ? "border-red-500/50 focus:border-red-500"
                                    : "border-purple-500/30 focus:border-purple-500/70"
                                    } text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 bg-white/5 backdrop-blur-sm transition-all duration-300 appearance-none`}
                                  {...field}
